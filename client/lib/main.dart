...
Future<void> main() async {
  ...
  // Optional disable via --dart-define=DISABLE_NOTIFICATIONS=true to speed up tests
  const bool disableNotifications = bool.fromEnvironment('DISABLE_NOTIFICATIONS', defaultValue: false);
  ...
  if (!disableNotifications) {
    ...
    debugPrint('Daily notification scheduling skipped (DISABLE_NOTIFICATIONS)');
  }
  ...
  if (!disableNotifications) {
    ...
    debugPrint('DB reminder scheduling skipped (DISABLE_NOTIFICATIONS)');
  }
